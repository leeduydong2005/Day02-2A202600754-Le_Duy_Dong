...
![Current workflow](assets/current-workflow.png)
...
Với nhóm 15 người, nếu mỗi người có khoảng 3–5 task đang mở, trưởng nhóm có thể phải theo dõi khoảng 45–75 task cùng lúc. Việc kiểm tra thủ công làm mất nhiều thời gian, dễ bỏ sót blocker và khiến rủi ro chỉ được phát hiện khi deadline đã gần.
...
[1 Thành viên cập nhật checklist: 5']
→ [2 Auto-pull task từ Jira/GitHub: 3']
→ [3 AI tổng hợp theo người/module: 2']
→ [4 AI phát hiện blocker/risk: 3']
→ [5 AI draft report: 2']
...
![Future workflow](assets/future-workflow.png)
